    ...
    <div x-data="{ sidebarOpen: true }" ">
        ...
        <div id="header"
            ...
            <div class="flex items-center">
                ...
                <h1 x-show="sidebarOpen" x-transition:enter="transition-opacity duration-500"
                    ...
                    class="text-lg font-semibold text-gray-700 w-60 border-r">Citra <span
                        class="text-yellow-500">TRAFFIC</span></h1>
            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="{{ route('client.index') }}"
                        class="text-sm flex text-secondary items-center p-2 rounded-lg hover:bg-yellow-100 group">
