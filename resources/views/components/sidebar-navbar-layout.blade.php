<x-app-layout>
    <!-- Alpine.js untuk mengontrol sidebar -->
    <div x-data="{ sidebarOpen: true }" ">
        <!-- Header yang fixed -->
        <div id="header"
            class="fixed top-0 left-0 w-full shadow-sm bg-white z-50 h-16 flex justify-between items-center px-6">
    ...
    <aside x-show="sidebarOpen"
        class="fixed top-16 left-0 z-40 w-64 h-[calc(100vh-4rem)] bg-white transition-transform  overflow-y-auto"
        ...
        <div class="h-full px-3 py-4">
            ...
            <ul class="space-y-2 font-medium">
                ...
                @if ($akses === 'admin' || $akses === 'traffic')
                    ...
                    <li>
                        <a href="{{ route('iklan.index') }}"
                            ...
                            <span class="flex-1 ms-3 whitespace-nowrap">Iklan</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li x-data="{ open: false }">
                        <button @click="open = !open"
                            class="mb-2 w-full text-sm flex items-center p-2 rounded-lg hover:bg-rose-100 transition-all duration-200 group text-red_1 opacity-70 hover:text-red_2">
                            <!-- Icon -->
                        ...
                        <!-- Submenu -->
                        <ul x-show="open" x-transition class="ml-8 space-y-2 text-sm">
                            <li>
                                <a href="{{ route('buatLaporan') }}"
                                    class="block p-2 rounded-lg hover:bg-rose-100 text-red_1 hover:text-red_2 transition-all duration-200  opacity-70">

                                    Laporan Bukti Siar
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('buatLaporanInternal') }}"
                                    class="block p-2 rounded-lg hover:bg-rose-100 text-red_1 hover:text-red_2 transition-all duration-200  opacity-70">
                                    Laporan Internal
                                </a>
                            </li>
                ...
                {{-- <li>
                    <a href="#"
                        class="text-sm flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
    ...
    <div :class="sidebarOpen ? 'sm:ml-64' : 'ml-0'" class="pt-20 transition-all duration-200">
        <div class="p-4">
            ...
            <div class="container px-5 pt-2 w-full mx-auto">
                {{ $slot }}
            </div>
        </div>
